...
class CollectionListRecyclerAdapter (
    layoutResId: Int, @Nullable data: List<CollectionListResponse.ContentBean?>?, context: Context?
) : BaseQuickAdapter<CollectionListResponse.ContentBean?, BaseViewHolder>(layoutResId, data) {

    var context: Context? = context
    var startEndTime = StringBuffer()
    override fun convert(helper: BaseViewHolder, item: CollectionListResponse.ContentBean?) {
