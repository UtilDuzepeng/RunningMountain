...
class IPostRecyclerAdapter (
    layoutResId: Int, @Nullable data: List<IPostResponse.ContentBean?>?, context: Context?
) : BaseQuickAdapter<IPostResponse.ContentBean?, BaseViewHolder>(layoutResId, data) {

    var context: Context? = context
    var startEndTime = StringBuffer()
    override fun convert(helper: BaseViewHolder, item: IPostResponse.ContentBean?) {
