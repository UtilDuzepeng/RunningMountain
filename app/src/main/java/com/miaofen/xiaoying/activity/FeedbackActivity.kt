...
class FeedbackActivity : BaseActivity() {
    ...
    override fun returnLayoutId() = R.layout.activity_feedback

    override fun initView() {
        super.initView()
        window.setSoftInputMode( WindowManager.LayoutParams.SOFT_INPUT_STATE_HIDDEN)
        title_bar_back.visibility = View.VISIBLE
        title_bar_title.text = "意见反馈"
        feedback_recyclerview.layoutManager = LinearLayoutManager(this, RecyclerView.HORIZONTAL, false)
        ...
        feedback_recyclerview.adapter = mAdapter
